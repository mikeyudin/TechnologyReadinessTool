			...
			<c:choose>
				<c:when test="${ orgSummary['networkPercentStudentsTestable'] == null or orgSummary['networkPercentStudentsTestable'] == 'TBD' }">
					<div class="report-org-text">
						...
						<div class="report-label2">It <span class="text-underline">cannot</span> be determined what % of Students can be Tested in the Window, based on <c:out value="${requirements}" /> Requirements</div><div style="clear: both;"></div>
					</div>
				</c:when>
				<c:otherwise>
					<div class="report-org-text">
