...
@Component
public class HourlyReportBatchJobTasklet extends BaseTasklet implements Tasklet {
	...
	private Logger log = LoggerFactory.getLogger(HourlyReportBatchJobTasklet.class);
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		log.debug("********************** Hourly Report Generation Run ************************");
		...
		for (Scope s : childScopes) {
			...
			reportsService.createSnapshotRollup(snapshotWindow.getSnapshotWindowId(), false);
		}

		log.debug("********************** Hourly Report Generation Run --Complete-- ************************");
