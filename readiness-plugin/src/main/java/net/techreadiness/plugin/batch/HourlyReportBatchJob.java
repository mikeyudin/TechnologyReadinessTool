...
/*
 * This is the job wrapper for the Hourly report runs.  The injected tasklet is
 * where the actual work is accomplished (or at least initiated).
 * 
 */

@Component
public class HourlyReportBatchJob extends BaseJobBean {

	@Inject
	HourlyReportBatchJobTasklet HourlyReportBatchJobTasklet;
