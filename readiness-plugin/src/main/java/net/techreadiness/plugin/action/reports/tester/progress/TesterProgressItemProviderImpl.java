...
public class TesterProgressItemProviderImpl extends ReportItemProviderImpl {
		...
		if (exportType.equals(ExportType.pdf)) {
			for (Map<String, String> map : results) {
				for (Map.Entry<String, String> entry : map.entrySet()) {
					...
					if (entry.getKey().startsWith("testTakerPercentStudentsTestable_")) {
						...
						String snapshotId = percentKey.replace("testTakerPercentStudentsTestable_", "");
