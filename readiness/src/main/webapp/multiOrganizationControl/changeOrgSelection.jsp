...
<style>
	...
	<label for="org" style="padding: 2px; display: block;"><s:text name="core.searchForOrganizations" /></label>
	<input id="org" style="width: 20em; float: left;">
	<span id="orgDownArrow" class="ui-icon ui-icon-triangle-1-s"></span>

	<s:a action="add" id="addItemUrl" cssStyle="display: none">
